      ...
      <main>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          ...
          <router-link to="/registro-diario" class="shortcut-card">
            ...
            <p class="mt-1 text-sm text-slate-400">Lance as atividades e a produção diária.</p>
          </router-link>
          ...
          <router-link to="/relatorios" class="shortcut-card">
            ...
            <h3 class="mt-4 text-lg font-semibold text-white">Relatórios</h3>
            <p class="mt-1 text-sm text-slate-400">Visualize e filtre os registros de atividades.</p>
          </router-link>
          
          <router-link to="/folha-pagamento" class="shortcut-card">
            <div class="flex items-center justify-center h-12 w-12 rounded-lg bg-rose-500 text-white">
            ...
            <h3 class="mt-4 text-lg font-semibold text-white">Folha de Pagamento</h3>
            <p class="mt-1 text-sm text-slate-400">Calcule e visualize os pagamentos dos trabalhadores.</p>
          </router-link>
          ...
          <router-link to="/trabalhadores" class="shortcut-card">
            ...
            <p class="mt-1 text-sm text-slate-400">Adicione e mantenha o registro dos trabalhadores.</p>
          </router-link>
          ...
          <router-link to="/servicos" class="shortcut-card">
            ...
            <p class="mt-1 text-sm text-slate-400">Cadastre, edite e visualize os serviços.</p>
          </router-link>
          ...
          <router-link to="/usuarios" class="shortcut-card">
            ...
            <p class="mt-1 text-sm text-slate-400">Controle o acesso ao sistema.</p>
          </router-link>
        </div>
        ...
        <div class="card p-6">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 text-center">
            <div class="bg-slate-900/50 p-4 rounded-lg"><p class="text-sm text-slate-400">Serviços</p><p class="text-3xl font-bold text-white mt-1">{{ serviceCount }}</p></div>
            <div class="bg-slate-900/50 p-4 rounded-lg"><p class="text-sm text-slate-400">Fazendas</p><p class="text-3xl font-bold text-white mt-1">{{ farmCount }}</p></div>
            <div class="bg-slate-900/50 p-4 rounded-lg"><p class="text-sm text-slate-400">Trabalhadores</p><p class="text-3xl font-bold text-white mt-1">{{ workerCount }}</p></div>
            <div class="bg-slate-900/50 p-4 rounded-lg"><p class="text-sm text-slate-400">Usuários</p><p class="text-3xl font-bold text-white mt-1">{{ userCount }}</p></div>
          </div>
        </div>
      </main>
    </div>
